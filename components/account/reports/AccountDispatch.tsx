...
const AccountDispatch = ({
  ...
  return (
    <div className=" dark:text-whiteColor text-white md mb-5">
      <div className="grid grid-cols-3 gap-2">
        {/* Card for top account */}
        <div className="dark:bg-darkColor dark:text-whiteColor text-black border-gray-200  shadow-md py-5 px-5 rounded-md flex flex-col justify-between">
          <div>
          ...
          <div className=" border-t-2 border-gray-600 grid grid-cols-2 justify-center ">
            <div className="p-2 border-r border-gray-600 flex gap-2 items-center">
              <TrendingUp className="bg-bgDarkColor p-2 h-8 w-8 rounded-full text-white" />
              <div>
                <p className="text-xs mb-2">Engagement</p>
                <p className="dark:bg-[#21BA4526] bg-green-300 text-white text-sm px-5 py-1 rounded-md">
            ...
            <div className="p-2 flex gap-2 items-center">
              ...
              <div>
                ...
                <p className="dark:bg-[#21BA4526] bg-green-300 text-white text-sm px-5 py-1 rounded-md mt-2">
                  {accounts[0].score}
                </p>
              </div>
            </div>
        ...
        <div className=" col-span-2 grid grid-cols-2 gap-2">
          {accounts.slice(1, accounts.length).map((item) => (
            <div
              className="dark:bg-darkColor dark:text-whiteColor flex flex-col justify-between text-black  shadow-md  py-5 px-2"
              key={item.id}
            >
