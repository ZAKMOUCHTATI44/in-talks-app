...
const ListAffichage = ({ props }: { props: Props }) => {
  return (
    <div className="dark:bg-darkColor bg-white shadow-md dark:text-whiteColor  border border-gray-200 dark:border-gray-600 p-5 rounded-md">
            ...
            <div className="flex gap-2 items-center">
              ...
              >
                <div className="flex justify-between">
                  <p className="capitalize text-xs">{item.key}</p>
                  {item.value && (
