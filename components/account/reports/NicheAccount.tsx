...
const NicheAccount = ({ data }: { data: Account }) => {
  return (
    <div className="dark:bg-darkColor bg-white dark:text-whiteColor text-black shadow-lg border-gray-200 border py-5 px-5 rounded-md flex justify-between items-center">
